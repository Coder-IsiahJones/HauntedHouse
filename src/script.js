...
const bricksColorTexture = textureLoader.load('./textures/bricks/Wood/color.jpg')
const bricksAmbientOcclusionTexture = textureLoader.load('./textures/bricks/Wood/ambientOcclusion.jpg')
const bricksNormalTexture = textureLoader.load('./textures/bricks/Wood/normal.jpg')
const bricksRoughnessTexture = textureLoader.load('./textures/bricks/Wood/roughness.jpg')
